package com.mobivault.utils.crop;
...
public final class CropImage {
    ...
    /** The key used to pass crop image source URI to { CropActivity}. */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /** The key used to pass crop image options to { CropActivity}. */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /** The key used to pass crop image bundle data to { CropActivity}. */
    public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

    /** The key used to pass crop image result data back from { CropActivity}. */
    ...
    /**
     * Same as { #startPickImageActivity(Activity) startPickImageActivity} method but instead of
     ...
     * image.<br>
     * Result will be received in {ctivity#onActivityResult(int, int, Intent)} and can be
