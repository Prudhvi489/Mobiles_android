package com.mobivault.ui.addmobiles
...
import com.mobivault.databinding.ActivityAddMobileDetailsBinding
import com.mobivault.interfaces.CalenderInterface
import com.mobivault.ui.addmobiles.adapter.MultiMediaAdapter
...
import com.mobivault.utils.CropActivity
import com.mobivault.utils.goneView
import com.mobivault.utils.setOnSafeClickListener
...
class AddMobileDetailsActivity :
    ...
    private fun getIntentData() {
        imei = intent.getStringExtra(AppStrings.IntentData.imei) //nothing but id
...
//        jsonObject.put(AppStrings.InputData.imageKeys, AppMethods.getStringArrayList(viewModel.multipleImagesListToBackend) )
    ...
    private fun updateAssetApiCall() {
        var jsonObject = JSONObject()
        jsonObject.put(AppStrings.InputData.mobileModel, viewModel.mobileModel.value)
        jsonObject.put(AppStrings.InputData.id, imei)
        jsonObject.put(AppStrings.InputData.imei, viewModel.imei.value)
            ...
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                if (data != null) {
                    ...
                    if (typeFrom == AppStrings.Types.imageCamera) {
                        ...
                        // Directly add the image without cropping
